    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{route('checkout.home')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                <li><a href="{{route('checkout.hotel', 1)}}"><i class="fa fa-bed"></i> <span>Checkout</span></a></li>
                <li><a href="{{route('checkout.logout')}}"><i class="fa fa-power-off"></i> <span>Logout</span></a></li>
