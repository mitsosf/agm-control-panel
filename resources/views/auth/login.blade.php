    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card" style="margin-top: 3%">
                ...
                <div class="card-body">
                    <p style="color: red;text-align: center">Disclaimer: Contains realistic dummy data, generated by the <a href="https://github.com/fzaninotto/Faker" target="_blank">Faker</a> library.</p>
                    <table class="table">
                        <thead>
                        <tr>
