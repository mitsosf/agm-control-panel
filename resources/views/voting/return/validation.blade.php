...
@section('content')
    <div style="text-align: center">
        ...
        <a id="confirm" href="{{route('voting.return.device',$delegation_id)}}" class="btn btn-success">Confirm</a>
        <a href="{{route('voting.return.round',$delegation->vote_round_id)}}" class="btn btn-danger">Back</a>
    </div>
@endsection
